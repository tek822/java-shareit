...
class ItemControllerTest {
    ...
    @Test
    void searchItemWithEmptyStringTest() throws Exception {
        when(itemService.findAvailable(anyString(), anyInt(), anyInt())).thenReturn(List.of());
        ...
        verify(itemService, times(1)).findAvailable("", 0, 20);
    }
    ...
    void validationSearchItemTest() throws Exception {
        ...
        verify(itemService, never()).findAvailable(anyString(), anyInt(), anyInt());
    }
