...
class BookingControllerTest {
    ...
    @Test
    void addBookingWithIvalidDtoTest() throws Exception {
        when(bookingService.add(anyLong(), any())).thenThrow(new BookingBadRequestException("Ошибка валидации резервирования: "));
